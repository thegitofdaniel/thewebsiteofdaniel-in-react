    ...
    return (
        <section className="skills" id="skills">
            ...
            <div className="container">
                <Skill title="Data Science" icon="model_training" items={dataScienceItems} />
                <Skill title="MLOPS" icon="diversity_3" items={mlopsItems} />
                <Skill title="Finance" icon="payments" items={financeItems} />
            </div>
        </section>
    );
}
